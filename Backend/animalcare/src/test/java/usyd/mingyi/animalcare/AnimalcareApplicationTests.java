...
class AnimalcareApplicationTests {
    ...
    public void loginTest() throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post(url)
                ...
                .andDo(print())
                .andReturn();
        //get session when login and used for rest of tests
    ...
    @Test
    public void signUpTest() throws Exception { //No new user is really added to the database because of @Transactional
    ...
    @Test
    public void addPetTest() throws Exception { //No new pet will be added to the database（@Transactional）
    ...
    @Test
    public void getPetListTest() throws Exception {
